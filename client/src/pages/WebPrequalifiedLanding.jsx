...
const WebPrequalified = () => {
  ...
  return (
    <div className="flex flex-col justify-between items-center bg-gray-50 w-screen h-screen relative">
      ...
      <div className="md:min-w-[800px] md:w-1/2 text-justify bg-white rounded-3xl p-8 md:p-12 m-14 shadow-[5px_5px_10px_rgba(0,0,0,0.3)] text-sm md:text-lg flex flex-col items-center">
        {<FirstPage_landing />}
        {<SecondPage_landing />}
        {<ThirdPage_landing />}
      </div>
